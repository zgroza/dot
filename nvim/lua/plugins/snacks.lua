...
return {
  ...
  keys = {
    ...
    { "<leader>n", function() Snacks.picker.notifications() end, desc = "Notification History", },
    {
      "<leader>e",
      function()
        Snacks.explorer({ layout = { preset = "vscode", }, hidden = true, ignored = true, auto_close = true, })
      end,
      desc = "File Explorer",
    },
    ...
    { "<leader>gm", function() Snacks.picker.git_diff({base = "origin/main", }) end, desc = "Git Diff (vs main)", },
    ...
    { "<leader>gb", function() Snacks.git.blame_line() end, desc = "Show blame line" },
    -- Notifications
    ...
    -- Dim
    { "<leader>D", function() if(Snacks.dim.enabled) then Snacks.dim.disable() else Snacks.dim.enable() end end, desc = "Dim toggle", },
    -- Zen
